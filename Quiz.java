...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        this.name = name;
        setBounds(50, 50, 1266, 668);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/quiz.jpg"));
        JLabel image = new JLabel(i1);
        image.setBounds(0, 0, 1266, 318);
        add(image);

        qno = new JLabel();
        qno.setBounds(50, 330, 50, 30);
        qno.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(qno);

        question = new JLabel();
        question.setBounds(90, 330, 900, 30);
        ...
        opt1.setBounds(100, 370, 700, 30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 18));
        add(opt1);

        opt2 = new JRadioButton();
        opt2.setBounds(100, 400, 700, 30);
        ...
        next.setBounds(1000, 380, 200, 30);
        ...
        lifeline.setBounds(1000, 420, 200, 30);
        ...
        submit.setBounds(1000, 460, 200, 30);
